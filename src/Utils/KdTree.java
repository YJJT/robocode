...
public abstract class KdTree<T> {
     ...
     */
    public void addPoint(double[] location, double value) {
	...
	public static class Entry<Double> {
    ...
    public List<Entry<Double>> nearestNeighbor(double[] location, int count, boolean sequentialSorting) {
        ...
        List<Entry<Double>> results = new ArrayList<Entry<Double>>(resultHeap.values);
